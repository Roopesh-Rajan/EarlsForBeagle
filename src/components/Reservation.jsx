...
const ReservationSection = () => {
  ...
  return (
    <div id="contact" className="bg-slate text-white font-sans min-h-screen flex items-center justify-center py-12">
      <div className="container mx-11 grid grid-cols-1 lg:grid-cols-2 gap-8 px-4" >
        ...
        <div className="flex flex-col justify-center space-y-8 mr-20">
          <div>
            <h3 className="text-gold text-4xl font-title italic mb-2">Reservations</h3>
            ...
            <img src={Swoosh} alt="swoosh" className="w-16" />
          </div>
          <div className="flex space-x-4">
            <button className="px-6 py-2 bg-transparent border-2 border-white text-white rounded-md hover:bg-gray-700 transition">
              Book a Table
            </button>
            <button className="px-6 py-2 bg-gold text-black font-semibold rounded-md hover:bg-yellow-600 transition">
              Spacial Food
            </button>
          </div>
          <div className="bg-blueblack bg-opacity-80  p-6 shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
              <div>
                <h3 className="text-white text-2xl font-bold mb-4">SPACIAL <br /><span className="text-gold" >FOOD</span></h3>
